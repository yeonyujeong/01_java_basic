...
public class LoopEx10_복습1 {

	public static void main(String[] args) { //2020.12.16  1:01 - 1:19
		...
		while(isRun) {
			...
			if (sel == 1) {
				...
				if(identifier == -1) {
					...
					System.out.println("dbAcc1님, 이미 로그인 되어있습니다.");
				}
				else if(identifier == 2) {
					System.out.println("dbAcc2님, 이미 로그인 되어있습니다.");
				}
				...
				if(identifier == -1) {
					...
					System.out.println("dbAcc1님, 현재 잔액 : " + dbMoney2 + "원");
				}
